...
export default function Home() {
  ...
  const handleGetRequest = async () => {
    const res = await fetch('https://tech0-gen-8-step3-testapp-py2-31/api/hello', {
      method: 'GET',
    });
  ...
  const handleIdRequest = async (e) => {
    ...
    const res = await fetch(`https://tech0-gen-8-step3-testapp-py2-31/api/multiply/${id}`, {
      method: 'GET',
    });
    const data = await res.json();
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch('https://tech0-gen-8-step3-testapp-py2-31/api/echo', {
      method: 'POST',
      headers: {
